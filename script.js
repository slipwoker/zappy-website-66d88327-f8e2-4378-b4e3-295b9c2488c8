  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
      ...
      function showError(input, message) {
        var formGroup = input.closest('.form-group') || input.parentElement;
        ...
        if (!errorMessages[input.name]) {
          ...
          errorMessages[input.name] = errorSpan;
        }
        errorMessages[input.name].textContent = message;
      }
      ...
      function clearError(input) {
        ...
        if (errorMessages[input.name]) {
          errorMessages[input.name].textContent = '';
        }
      }
      ...
      contactForm.addEventListener('submit', function(e) {
        ...
        inputs.forEach(function(input) {
          ...
          if (input.name === 'name' && input.value.trim() && input.value.trim().length < 2) {
            showError(input, 'Name must be at least 2 characters');
            isValid = false;
          }
          
          if (input.tagName === 'TEXTAREA' && input.value.trim() && input.value.trim().length < 10) {
...
/* SIGNATURE MOMENT: smart-back-to-top */
(function(){

      (function(){
        var btn = document.createElement('button'); btn.className = 'zsm-totop'; btn.setAttribute('aria-label', 'Back to top'); btn.textContent = '↑'; document.body.appendChild(btn);
        function update(){ if (window.scrollY > 600) btn.classList.add('is-visible'); else btn.classList.remove('is-visible'); }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '66d88327-f8e2-4378-b4e3-295b9c2488c8',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '66d88327-f8e2-4378-b4e3-295b9c2488c8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '66d88327-f8e2-4378-b4e3-295b9c2488c8';
